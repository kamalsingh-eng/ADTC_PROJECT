...
if ( seatBeltStatus == 0 ) {
 ...
 StaticJsonDocument<200>JSONencoder;
  ...
  JSONencoder["ID"] = "distance_sick_seensor";
  JSONencoder["NCH1"] = dis1;
  JSONencoder["NCH2"] = dis2;
  JSONencoder["NCH3"] = dis3;
  JSONencoder["NCH4"] = dis4;
  JSONencoder["NCH5"] = seatbelt_status;
  ...
  client.publish("distance_sick_seensor",msg101);
