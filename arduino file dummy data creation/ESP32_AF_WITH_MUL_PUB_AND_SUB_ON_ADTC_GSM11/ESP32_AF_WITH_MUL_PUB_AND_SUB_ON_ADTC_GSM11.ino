...
const char* mqtt_server = "192.168.0.241"; //192.168.0.241
...
if ((pub == 0) || (pub1==0)){
  ...
  //  size_t n1 = serializeJsonPretty(JSONencoder1, JSONmessageBuffer1);
    client.publish("ADTC/GSM1", JSONmessageBuffer);
...
if (pub == 0 ){
    ...
    client.publish("ADTC/LS1", JSONmessageBuffer2);
...
if (pub == 0 ){
    ...
    client.publish("ADTC/GS1", JSONmessageBuffer3);
